...
\begin{figure}[!htb]
        \centering
        \includegraphics[scale=0.6]{getvaluebin.png}
...
\begin{figure}[!htb]
        \centering
        \includegraphics[scale=0.6]{injectedshell.png}
...
\begin{figure}[!htb]
        \centering
        \includegraphics[scale=0.4]{remote_attack_conf.png}
...
\begin{figure*}[!htb]
        ...
        \begin{subfigure}[t]{0.45\textwidth}
          \includegraphics[scale=0.5]{record_graph.png}
                \caption{Flowgraph for Recording}
                \label{fig:recordgraph}
        \end{subfigure}
        \begin{subfigure}[t]{0.45\textwidth}
          \includegraphics[scale=0.5]{replay_graph.png}
